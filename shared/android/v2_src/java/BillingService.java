...
import ${PACKAGE_NAME}.Security.VerifiedPurchase;
...
public class BillingService extends Service implements ServiceConnection {
    ...
    abstract class BillingRequest {
        ...
        public boolean runRequest()
         {
          Log.d(TAG, "RunRequest");
           
            if (runIfConnected())
             {
              Log.d(TAG, "RunRequest -- already connected");
            ...
            if (bindToMarketBillingService())
             {
                ...
                mPendingRequests.add(this);
                  Log.d(TAG, "RunRequest -- binding");
         
                return true;
            }

                  Log.d(TAG, "RunRequest --got to end, error?");
    ...
    public void unbind()
     {
       //Log.w(TAG, "Unbinding billing service");
        try {
            unbindService(this);
