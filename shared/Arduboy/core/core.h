...
{
public:
	int8_t transfer(int8_t val)
	{
		return 0;
	}
	int16_t transfer16(int16_t val16)
	{
		return 0;
	}
};
...
protected:
    ...
    // internals
    void static inline setCPUSpeed8MHz();
    void static inline bootOLED();
    void static inline bootPins();
    void static inline bootPowerSaving();
