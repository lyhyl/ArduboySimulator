//  ***************************************************************
//  Arduboy - Creation date: 05/26/2016
//  -------------------------------------------------------------
...
{
public:
	bool buttonStatus[GAME_KEY_COUNT];
	GameKeys()
	{
		memset(buttonStatus, sizeof(buttonStatus), 0);
	}
};

extern GameKeys g_gameKeys;

//Proton stuff by Seth
void delay(long timeMS);
