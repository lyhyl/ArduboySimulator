...
//some major windows specific hacks to allow procedural code with inline delays to work right and still process keystrokes/etc
...
{
	return (uint32)GetSystemTimeAccurate();
}
