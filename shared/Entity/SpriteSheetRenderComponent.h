//  ***************************************************************
//  SpriteSheetRenderComponent - Creation date: 04/02/2012
//  -------------------------------------------------------------
//
//  ***************************************************************
...
#ifndef SpriteSheetRenderComponent_h__
#define SpriteSheetRenderComponent_h__
 ...
 */
class SpriteSheetRenderComponent: public EntityComponent
{
public:
	SpriteSheetRenderComponent();
	virtual ~SpriteSheetRenderComponent();
...
private:
	...
	void OnFrameNameChanged(Variant *pDataObject);
...
#endif // SpriteSheetRenderComponent_h__
