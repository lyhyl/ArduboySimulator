...
#else
//using PowerVR/Common Debug build profile this also works under Windows and other mobile devices, as
//Proton handles the actual GL init
...
#define _IRR_COMPILE_WITH_RTTEX_LOADER_
