...
public:
	...
	//! if bytesSize is 0 it is calculated, otherwise it will trust you on how much data is being sent in
	CImage(ECOLOR_FORMAT format, const core::dimension2d<u32>& size,
		void* data, bool ownForeignMemory=true, bool deleteMemory = true, u32 bytesSize = 0);
...
private:
	...
	bool DeleteMemory;
	u32 TotalSizeBytes; //SETH Added so I can do copies of compressed textures
};
