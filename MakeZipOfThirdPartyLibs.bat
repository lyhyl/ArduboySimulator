...
xcopy shared\iOS\60BeatGamepad ztemp\shared\iOS\60BeatGamepad /E /F /Y /I
xcopy shared\iOS\ChartBoost ztemp\shared\iOS\ChartBoost /E /F /Y /I
xcopy shared\iOS\fmod ztemp\shared\iOS\fmod /E /F /Y /I
xcopy shared\iOS\TapjoyConnectVirtualGoodsSDK_iOS ztemp\shared\iOS\TapjoyConnectVirtualGoodsSDK_iOS /E /F /Y /I
