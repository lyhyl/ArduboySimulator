...
set(PROTON_SOURCES "${PROTON_SHARED}/BaseApp.cpp" "${PROTON_SHARED}/PlatformSetup.cpp" "${PROTON_SHARED}/linux/LinuxUtils.cpp" "${PROTON_SHARED}/linux/LinuxMain.cpp" "${PROTON_UTIL}/VideoModeSelector.cpp" "${PROTON_UTIL}/PassThroughPointerEventHandler.cpp" "${PROTON_UTIL}/TouchDeviceEmulatorPointerEventHandler.cpp"
	...
	"${PROTON_RENDERER}/Surface.cpp" "${PROTON_RENDERER}/SoftSurface.cpp" "${PROTON_RENDERER}/SurfaceAnim.cpp" "${PROTON_RENDERER}/SpriteSheetSurface.cpp" "${PROTON_RENDERER}/SpriteAnimation.cpp" "${PROTON_RENDERER}/RenderBatcher.cpp"
...
macro(proton_include_all_components)
	proton_include_components(ArcadeInputComponent Button2DComponent Component CustomInputComponent DPadComponent EmitVirtualKeyComponent FilterComponent FilterInputComponent FocusInputComponent FocusRenderComponent FocusUpdateComponent HTTPComponent InputTextRenderComponent InterpolateComponent LogDisplayComponent OverlayRenderComponent ProgressBarComponent RectRenderComponent RenderClipComponent RenderScissorComponent ScrollBarRenderComponent ScrollComponent SelectButtonWithCustomInputComponent SliderComponent SplashComponent SpriteAnimationRenderComponent SpriteSheetRenderComponent StringChooserComponent TapSequenceDetectComponent TextBoxRenderComponent TextRenderComponent TouchDragComponent TouchHandlerComponent TouchStripComponent TrailRenderComponent TyperComponent UnderlineRenderComponent)
	...
	list(APPEND PROTON_SOURCES "${PROTON_ENTITY}/EntityUtils.cpp" "${PROTON_ENTITY}/SpriteAnimationUtils.cpp")
